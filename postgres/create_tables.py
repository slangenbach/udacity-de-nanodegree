...
def create_database():
    ...
    conn = psycopg2.connect("host=127.0.0.1 dbname=rootdb user=root password=r00tp4ss")
    ...
    conn = psycopg2.connect("host=127.0.0.1 dbname=sparkifydb user=root password=r00tp4ss")
    cur = conn.cursor()
